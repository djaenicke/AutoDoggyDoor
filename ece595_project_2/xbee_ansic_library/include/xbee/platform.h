...
#elif defined __MCUXPRESSO && defined FRDM_K64F
	#include <xbee_ansic_library/include/xbee/platform_k64f.h>
#else
...
#include <xbee_ansic_library/include/xbee/jslong_glue.h>
